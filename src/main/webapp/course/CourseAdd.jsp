...
<div class="container">
    <div class="breadcrumb"><a href="${pageContext.request.contextPath}/dashboard">首页</a><span class="separator">&#9656;</span><a href="${pageContext.request.contextPath}/course/list">课程管理</a><span class="separator">&#9656;</span><span class="current">新增课程</span></div>
    <div class="form-container">
        ...
        <form action="${pageContext.request.contextPath}/course/add" method="post">
            <div class="form-group">
                ...
                <input type="text" name="courseNo" placeholder="请输入课程编号" required maxlength="20">
            </div>
            <div class="form-group">
                <label>课程名称 <span class="required">*</span></label>
                <input type="text" name="name" placeholder="请输入课程名称" required maxlength="20">
            </div>
            <div class="form-group">
                <label>学分 <span class="required">*</span></label>
                <input type="number" step="0.5" name="credit" placeholder="请输入学分" required min="0" max="10">
            </div>
            <div class="form-group">
                <label>学时 <span class="required">*</span></label>
                <input type="number" name="hours" placeholder="请输入学时" required min="0">
            </div>
            <div class="btn-group">
