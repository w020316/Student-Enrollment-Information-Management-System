...
<div class="container">
    <div class="breadcrumb"><a href="${pageContext.request.contextPath}/dashboard">首页</a><span class="separator">&#9656;</span><a href="${pageContext.request.contextPath}/student/list">学生管理</a><span class="separator">&#9656;</span><span class="current">新增学生</span></div>
    <div class="form-container">
        ...
        <form action="${pageContext.request.contextPath}/student/add" method="post">
            <div class="form-group">
                ...
                <input type="text" name="studentNo" placeholder="请输入学号" required maxlength="20">
            </div>
            <div class="form-group">
