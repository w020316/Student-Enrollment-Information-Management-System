...
<div class="container">
    <div class="breadcrumb"><a href="${pageContext.request.contextPath}/dashboard">首页</a><span class="separator">&#9656;</span><a href="${pageContext.request.contextPath}/teacher/list">教师管理</a><span class="separator">&#9656;</span><span class="current">编辑教师</span></div>
    <%
    ...
    <div class="form-container">
        ...
        <form action="${pageContext.request.contextPath}/teacher/update" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="teacherNo" value="<%= teacher != null && teacher.getTeacherNo() != null ? teacher.getTeacherNo() : "" %>" required maxlength="20">
            </div>
            <div class="form-group">
                <label>姓名 <span class="required">*</span></label>
                <input type="text" name="name" value="<%= teacher != null ? teacher.getName() : "" %>" required maxlength="10">
            </div>
            <div class="form-group">
                <label>性别</label>
                <div class="radio-group">
                    <label class="radio-label"><input type="radio" name="gender" value="男" <%= teacher != null && !"女".equals(teacher.getGender()) ? "checked" : "" %>> 男</label>
                    <label class="radio-label"><input type="radio" name="gender" value="女" <%= teacher != null && "女".equals(teacher.getGender()) ? "checked" : "" %>> 女</label>
                </div>
            </div>
            <div class="form-group">
                <label>年龄 <span class="required">*</span></label>
                <input type="number" name="age" value="<%= teacher != null ? teacher.getAge() : "" %>" required min="1" max="150">
            </div>
            <div class="form-group">
                <label>薪资 <span class="required">*</span></label>
                <input type="number" step="0.01" name="salary" value="<%= teacher != null ? teacher.getSalary() : "" %>" required min="0">
            </div>
            <div class="btn-group">
